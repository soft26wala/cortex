            ...
            <section className="dark:bg-darkmode lg:pt-20 pt-16 lg:pb-24 pb-10">
                <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md">
                    ...
                    <div className="md:pt-28 pt-11 md:pb-28 pb-16">
                        ...
                        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d172.8198551741107!2d73.44730538016414!3d29.659062273717208!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e1!3m2!1sen!2sin!4v1766577771596!5m2!1sen!2sin" width="1114" height="477" style={{border:0}} allowFullScreen={true} loading="lazy" referrerPolicy="no-referrer-when-downgrade" className="rounded-lg w-full"></iframe>
                    </div>
                </div>
